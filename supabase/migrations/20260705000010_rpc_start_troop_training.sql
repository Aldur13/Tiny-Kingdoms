-- Validates cost, deducts resources, and queues a troop-training order.
...
begin
  ...
  select cost_wood, cost_food, train_seconds_base
  into v_cost_wood, v_cost_food, v_train_seconds_base
  from troop_types
