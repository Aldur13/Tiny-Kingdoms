-- Phase 2: new kingdoms get a 24-hour PvP protection window. Re-defines
-- join_server (originally added in 20260705000008_rpc_join_server.sql) to
-- set protected_until; the rest of the function is unchanged.
